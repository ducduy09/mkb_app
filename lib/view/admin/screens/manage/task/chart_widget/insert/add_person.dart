...
class AddPersonToTask extends StatefulWidget {
  const AddPersonToTask({super.key});

  @override
  _AddPersonToTaskState createState() => _AddPersonToTaskState();
}

class _AddPersonToTaskState extends State<AddPersonToTask> {
  bool accepted = false;
  late FToast fToast;
  ...
  void addUserToTask(
    ...
    try {
      List<Map<String, dynamic>> data =
          await IndexTaskHelper.checkTaskId(taskId, userId);
      if (data.isEmpty) {
        await IndexTaskHelper.insertTaskNow(taskId, userId, taskName, note);
